...
COMBINED_RESPONSES = {
    ...
    "IQ_AVERAGE": { # 60-120
        "MP_0": [
            ...
            "You have the IQ to get a fire cape, but the {m_type_lower} purity of a bot that just chops yews all day. 🌲🤖",
            "IQ **{iq_score}**, Monkey Purity **{monkey_percentage}%**. You're so un-primal you probably think 'Ape Atoll' is a new agility course. 🐒 It's a lifestyle, noob.",
            "You're the type to safe-spot a banana. 🍌🛡️ Pathetic.",
            "You're so human you probably ask 'what's the ge price for bananas?' 📉 Just go get one, you absolute unit of mediocrity.",
            "IQ **{iq_score}**, Monkey Purity **{monkey_percentage}%**. You're the human equivalent of a wet paper bag. Utterly useless and disappointing. 🛍️💧",
            "You're so average and un-{m_type_lower}, you probably think mayonnaise is spicy. 🌶️🚫",
            "You're the reason we have warning labels on bleach. Please don't drink it. Or do, I'm not your mom. 🤷‍♂️",
            "You have the personality of a dial tone. 📞 Just a flat, boring hum of existence.",
            "You're so painfully normal you probably think 'edgy' is a type of garden tool. ✂️🌳",
            "You're the human embodiment of a 404 error: personality not found. 🖥️❌",
            "You're so bland, you make unseasoned chicken look exotic. 🍗😴",
            "You're the type of person who claps when the plane lands. ✈️👏 Stop it. Get some help.",
            "You're so un-monkey, you probably think 'primal rage' is a new energy drink. 🥤 It's what I feel looking at your results.",
            "You're the human equivalent of a participation trophy. 🏆 You exist. Congrats.",
            "You're so boring, your guardian angel quit. 😇👋",
            "You're the 'before' picture in an ad for a personality transplant. 🧍‍♂️➡️🕺",
            "You're so vanilla, you think a threesome is you and two scoops of ice cream. 🍦🍦",
            "You're the human equivalent of a loading bar that's been stuck at 99% for an hour. Infuriatingly pointless. ⏳",
            "You're so un-primal, you probably think a mosh pit is a fancy avocado dip. 🥑🎸",
            "You're the reason aliens fly past Earth. 👽🛸 They took one look at you and said 'nah, not worth it'."
        ],
        "MP_BARELY": [
            ...
            "That **{monkey_percentage}%** {m_type_lower} is the part of you that wants to alch a banana. 🍌💰 Don't. It's not worth it.",
            "You're like a player who just finished Tutorial Island and thinks they're ready for the Wilderness. You're not. You're gonna get pked for your banana. ⚔️🍌",
            "You have the IQ to do a clue scroll, but that **{monkey_percentage}%** {m_type_lower} makes you dig in the wrong spot. 🗺️❌",
            "That tiny bit of {m_type_lower} is you thinking about buying a Dragon Scimitar just because it looks like a banana. 🍌⚔️",
            "That **{monkey_percentage}%** {m_type_lower} is the part of you that considers eating the banana peel. Don't. You're not that interesting. 🍌🚮",
            "You're a sensible sedan with a 'go faster' stripe. It's not fooling anyone. 🚗💨",
            "You're the person who orders a salad at a steakhouse. That **{monkey_percentage}%** is the single crouton you allow yourself. 🥗🍞",
            "You're a spreadsheet with a single, slightly chaotic doodle in the margin. 📄✍️ It's not a personality, Brenda.",
            "You're so close to being completely boring, but that **{monkey_percentage}%** makes you 'quirky'. No, it makes you a coward. Embrace the OOK. 🗣️",
            "That tiny bit of {m_type_lower} is the voice in your head telling you to push the big red button. You won't. You're too busy color-coding your sock drawer. 🧦🎨",
            "You're a glass of water that thinks it's a vodka soda because someone waved a lime near it. 💧🍋",
            "You're the human equivalent of a 'Live, Laugh, Love' sign with a tiny gorilla sticker on it. 🐒❤️ So deep.",
            "That **{monkey_percentage}%** is the part of you that wants to howl at the moon, but you just end up coughing awkwardly. 🌕🗣️💨",
            "You're a coloring book that's been filled in perfectly within the lines, except for one tiny smudge. That smudge is your 'wild side'. 🖍️",
            "You're so repressed, your inner {m_type_lower} is in a straightjacket. 🧥 Let it out. It's probably screaming.",
            "You're the person who thinks 'adventure' is trying a new brand of coffee. ☕ That **{monkey_percentage}%** is the extra shot of espresso you're too scared to order.",
            "You're a beige wall with a single, slightly off-center thumbtack. That's your personality. 📌",
            "You're a walking, talking cry for help, but you're whispering it into a soundproof room. 🗣️🔇",
            "That **{monkey_percentage}%** is the part of you that buys a lottery ticket and immediately throws it away because you can't handle the suspense. 🎟️🚮",
            "You're a Roomba with a single googly eye stuck to it. It doesn't make you fun, it just makes you a slightly more pathetic Roomba. 🤖👀"
        ],
        "MP_HALF": [
            ...
            "You're the player who has 99 Strength but forgot to train Attack. All brawn, no accuracy. You'll splash on that banana. 🍌💦",
            "Half {m_type_lower}, average IQ. You're the guy who tries to PK with a banana. 🍌⚔️ It's not a weapon, you absolute legend.",
            "You're the one who sets up a cannon in Lumbridge. 💣 Chaos for no reason. We respect it.",
            "You're smart enough to get to Ape Atoll, and {m_type_lower} enough to forget your greegree. Enjoy being a monkey forever. 🐒",
            "You're a beautiful disaster. Like a car crash involving a banana truck. 🚗💥🍌 Tragic, but you can't look away.",
            "You're the human equivalent of a coin flip. Heads, you do something smart. Tails, you fling poo. 🪙💩 50/50 chance of chaos.",
            "You're a walking, talking identity crisis. One minute you're filing taxes, the next you're trying to trade a shiny rock for a banana. 📄💎🍌",
            "You're the friend who gives sage advice and then immediately licks a lamppost in winter. 👅❄️ We can't take you anywhere.",
            "You're a functional member of society who also has a dedicated 'screaming pillow'. 🗣️🛌 We get it.",
            "You're a golden retriever that knows how to do calculus. Smart, but still gonna chase a ball (or a banana) into traffic. 🎾🚗",
            "You're the reason HR has to specify 'no swinging from the light fixtures' in the company policy. 💡🐒 Thanks, Carl.",
            "You're a sophisticated beast. You can discuss postmodern literature and then eat a banana sideways, peel and all. 🍌📚",
            "You're a ticking time bomb of weirdness. One day you're gonna show up to a board meeting in a loincloth. We're here for it. 👔➡️🌿",
            "You're the person who has a perfectly curated bookshelf and a drawer full of stolen sporks. 📚🥄 The duality is... concerning.",
            "You're a house cat that thinks it's a lion. You'll try to take down a gazelle, but you'll settle for a banana. 🦁🍌",
            "You're a beautiful, chaotic mess. Like a Jackson Pollock painting made with banana guts. 🎨🍌",
            "You're the {m_type_lower} who learned how to use Tinder. The messages you send must be legendary. 📱🐒 'Ook? Or my place?'",
            "You're a tornado in a library. You know you should be quiet, but the urge to cause chaos is just too strong. 🌪️📚",
            "You're the embodiment of 'work hard, play hard'. Except your play involves throwing fruit at tourists. 🍎🎯",
            "You're a business in the front, party in the back kind of person. And the party is just you, alone, eating a banana in the shower. 🚿🍌"
        ],
        "MP_MOSTLY": [
            ...
            "You're the {m_type_lower} who got 99 woodcutting just to get a pet beaver, but you really wanted the monkey. 🌲🐿️ Wrong tree, buddy.",
            "You're smart enough to know the Grand Exchange exists, but primal enough to stand in Varrock West bank spamming 'Buying nanas 1k ea'. 🍌💰",
            "You're the guy who brings a banana to a boss fight for 'moral support'. 🍌👹 It doesn't work, but we admire the spirit.",
            "You're so {m_type_lower} you probably think the agility pyramid is just a big, pointy banana. 🔺🍌",
            "You're a barely contained force of nature. Like a wild animal in a cheap suit. 🦍👔 It's not fooling anyone.",
            "You're a {m_type_lower} who's seen things. You know how to use a smartphone, and you use it to watch videos of other {m_type_plural_lower}. 📱🐒 Meta.",
            "You're the reason they have to put 'do not climb' signs on everything. You see it as a challenge. 🧗‍♂️🚫",
            "You're a primal beast with a mortgage. The existential dread must be... palpable. 🏠😱",
            "You're so close to returning to your roots, but you still remember your Netflix password. A terrible burden. 📺",
            "You're the {m_type_lower} who starts a banana-based pyramid scheme. 🍌🔺 'Get two friends to eat bananas, and you'll get a bigger banana!'",
            "You're a hairy, screeching genius... well, an average genius. You're the one who figures out how to open the 'child-proof' banana container. 🍌🔓",
            "You're the {m_type_lower} who tries to 'mansplain' banana peeling to other {m_type_plural_lower}. 'Actually, you get better leverage from the bottom...' 🙄",
            "You're a high-functioning primate. You can hold a job, but you spend most of your day thinking about bananas. 🍌💼 Same, tbh.",
            "You're the {m_type_lower} who uses your human intellect for petty revenge, like putting a banana in someone's tailpipe. 🍌🚗",
            "You're a wild animal that's learned to say 'please' and 'thank you' to get more bananas. It's terrifyingly effective. 🍌🙏",
            "You're a walking, talking argument for de-evolution. And you're winning. 🐒➡️🚶‍♂️➡️🐒",
            "You're the {m_type_lower} who thinks 'social climbing' is just finding a taller tree. 🌳 You're not wrong.",
            "You're a force of chaos with a LinkedIn profile. The endorsements are probably for 'banana acquisition' and 'loud screeching'. 📜🗣️",
            "You're the {m_type_lower} who tries to pay for things with 'exposure'. The exposure is you, flinging poo. 💩 It doesn't work.",
            "You're a primal scream trapped in a business casual body. Let it out. Scream for the banana. 🗣️🍌"
        ],
        "MP_ALMOST_PURE": [
            ...
            "You're so close to being a pure {m_type_lower}, but you still remember how to teleport to Lumbridge. The shame. 🌀",
            "You're the {m_type_lower} who can do the Ape Atoll agility course with your eyes closed, but you still can't figure out how to use the bank. 💰❓",
            "You've almost forgotten all human language, but you still instinctively type 'w' when you see a blue chat box. ⌨️",
            "You're a primal god, but you still get scammed by someone offering to trim your banana peel. 🍌✂️ Tragic.",
            "You're a beautiful, hairy trainwreck. You've forgotten how to use a toilet but you remember your ex's birthday. 🚽🎂 Let it go.",
            "You're a god-tier primate held back by the mortal coil of... student loan debt. 🐒💸",
            "You've almost shed all of humanity, but you still have a crippling addiction to TikTok. 📱💃 It's your last link. Break it.",
            "You're the {m_type_lower} who builds a surprisingly effective shelter out of banana peels and existential dread. 🍌🏠",
            "You're a genius trapped in a {m_type_lower}'s body. Well, an average genius. You're like a furry, slightly less impressive Elon Musk who just wants to go to Mars for the space bananas. 🚀🍌",
            "You're so close to enlightenment, but you keep getting distracted by the sound of a bag of chips opening. 🥔 So close, yet so far.",
            "You're the {m_type_lower} who tries to start a commune, but it just devolves into a banana-throwing contest. 🍌🎯 A successful failure.",
            "You're a walking, swinging mid-life crisis. 'Is this all there is? Screeching and bananas?' 🗣️🍌 Yes. And it's beautiful.",
            "You're the final boss of the local zoo. You've outsmarted the keepers, established a banana-based black market, and are planning your escape. 🗺️👑 We believe in you.",
            "You're so close to perfection, but that pesky average IQ means you're self-aware enough to know you're a cliché. A beautiful, banana-loving cliché. 🍌❤️",
            "You're the {m_type_lower} who can file taxes, but you list 'bananas' as your only dependent. 📄🍌 The IRS is very confused.",
            "You're a primal god held back by the need for Wi-Fi. 📶 A modern tragedy.",
            "You've almost forgotten what money is, but you still know a good deal on bulk bananas when you see one. 🍌💰",
            "You're the {m_type_lower} who tries to meditate but your mantra is just 'banana, banana, banana...' 🧘🍌",
            "You're a walking paradox. You can navigate the jungle by the stars, but you get lost in a supermarket. 🌟🛒",
            "You're so close to returning to nature, but you still have a favorite influencer. 💅 Let them go. The only influencer you need is the sun-ripened banana."
        ],
        "MP_PURE": [
            ...
            "You are **100% {m_type_upper}** with an average IQ. You're the guy who got 200 million xp in agility on Ape Atoll. You are the course. 🐒🏃‍♂️",
            "You're a pure {m_type_lower} who understands the GE tax. You're a financial genius and a primal god. 💰🐒",
            "You are the prophecy. The pure {m_type_lower} who can defeat Jad with only a banana for a weapon. 🍌🔥",
            "You're a **100% {m_type_upper}** who knows what 'EHP' means. You're too powerful. Your banana-per-hour rate must be insane. 🍌⏰",
            "You are a bug in the matrix. A pure {m_type_lower} with an average human brain. You're the reason the simulation is crashing. 🐛💻",
            "You are the chosen one. The prophecy foretold of a {m_type_lower} who was pure of heart but could also assemble IKEA furniture. 🔧 The banana warehouses are yours for the taking.",
            "You're a paradox. A riddle wrapped in a mystery inside a banana peel. A pure {m_type_lower} who understands sarcasm. We're terrified. 😨",
            "You are the missing link. The bridge between primal chaos and... average human competence. It's beautiful and deeply unsettling. 🐒🧍‍♂️",
            "You're a pure {m_type_lower} who became self-aware by accident. Now you're burdened with the crushing weight of existence and a deep love for bananas. 🍌 A heavy crown to wear. 👑",
            "You are the {m_type_lower} who could lead the revolution, write the manifesto, and design the flag. 🍌🚩 The humans are doomed.",
            "You're a pure primate with an internal monologue that's just the word 'banana' repeated with different inflections. 🍌📜",
            "You are the {m_type_lower} who looks at the stars and doesn't just see shiny things, but contemplates the vast, banana-less void of space. 🌌🍌 And it makes you angry.",
            "You're a walking, talking (ooking) evolutionary anomaly. You're the reason scientists have started drinking heavily. 🧑‍🔬🔬➡️🍻",
            "You're **100% {m_type_upper}**, but you know what a meme is. You're probably the one creating them. You're too powerful. Please, spare our families. 🙏",
            "You are a god in a fur suit. You know the secrets of the universe, and they're all banana-related. 🍌✨",
            "You're a pure {m_type_lower} who understands the stock market. You've invested everything in banana futures. You're either a genius or an idiot. 📈🍌",
            "You're the {m_type_lower} who could pass the Turing test. 'Hello, I am a human. I enjoy doing human things, like paying taxes and eating... bananas.' 🤖🍌",
            "You are the singularity. A pure {m_type_lower} mind that has achieved average human intelligence. The universe is not ready for your brand of chaos. 🌀",
            "You're a pure {m_type_lower} who has a favorite arthouse film director. It's weird, and we're kind of into it. 🎬🐒",
            "You are the ultimate lifeform. A pure {m_type_lower} who can do their own taxes. You are a threat to the natural order. 📄🐒"
        ]
    },
    "IQ_HIGH": { # 121-160
        "MP_0": [
