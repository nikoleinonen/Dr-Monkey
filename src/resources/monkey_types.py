...
PRIMATE_TYPES = [
    ...
    # Old School RuneScape (OSRS) themed monkeys.
...
def get_random_monkey_type() -> str:
    """Returns a random primate type from the predefined list."""
    return random.choice(PRIMATE_TYPES)

def get_plural_monkey_type(monkey_type: str) -> str:
    """Returns the plural form of a given monkey type using basic English rules."""
